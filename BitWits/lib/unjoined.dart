          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 20),
                Container(
                  child: Text("Select one of the following options",style: TextStyle(color: Colors.grey[600],fontSize: 16),),
                ),
                Container(
                  color: Colors.white,
                ...
                FlatButton(
                  ...
                  child: Text("Sign out",style: TextStyle(color: Colors.grey[600],fontSize: 15,decoration: TextDecoration.underline),),
                )
              ],
            ),
          ),
